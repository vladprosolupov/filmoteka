                ...
                <section class="hero">
                    <article id="bookmarkInfo" class="message is-info" style="display: none">
                        ...
                        <div class="message-body">
                            You have successfully added that film to <strong>your bookmarks</strong>, now you can find
                            it in your <strong>profile</strong>, or <strong>navigation bar dropdown menu</strong>.
                        </div>
                    </article>
                    <div class="hero-body">
                        <article id="filmInfo" class="media">
                            <figure class="media-left">
                                ...
                                <p style="display: flex; margin-top: 5px;" class="centered">
                                    ...
                                    <a class="button is-success is-outlined" style="width: 70px; margin: 5px;"
                                       v-on:click="like" v-if="!liked"><i class="fa fa-thumbs-o-up"
                                                                          aria-hidden="true"></i>{{likes}}</a>
                                    <a class="button is-danger" style="width: 70px; margin: 5px;" v-on:click="dislike"
                                       v-if="disliked"><i class="fa fa-thumbs-o-down" aria-hidden="true"></i>{{dislikes}}</a>
                                    <a class="button is-danger is-outlined" style="width: 70px; margin: 5px;"
                                       v-on:click="dislike" v-if="!disliked"><i class="fa fa-thumbs-o-down"
                                                                                aria-hidden="true"></i>{{dislikes}}</a>
                                <div id="likeInfoMessage" class="message is-info" style="display: none;"
                                     v-if="currUser.login == null">
                                    <div class="message-body">
