    ...
    <div class="container vue" style="display: none">
        <div class="columns">
            ...
            <div class="column is-9">
                ...
                <article class="message is-danger" v-if="!logged">
                    <div class="message-body" style="text-align: center">
                        Please <strong><a href="/login">Log in</a></strong> in order to view your suggestions.
                    </div>
                </article>
                ...
                <section class="info-tiles" v-if="logged">
                    <div class="films">
                ...
                <nav class="pagination is-centered" role="navigation" aria-label="pagination" v-if="logged && pagesNumber != 0">
